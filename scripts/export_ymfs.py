"""
Script para exportar YMFS (propiedad de inyección) desde ResInsight.
"""
...
def export_ymfs_timesteps(egrid_file, output_dir=None):
    """Exporta YMFS para todos los timesteps."""
    ...
    if output_dir is None:
        output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "timesteps_export")
    
    os.makedirs(output_dir, exist_ok=True)
    
    print("="*60)
    print("Exportando YMFS desde ResInsight")
    print("="*60)
        ...
        try:
            ...
            if values:
                ...
                with open(output_file, 'w') as f:
                    ...
                    f.write("/\n")
                print(f"  ✓ YMFS exportado -> {output_file}")
            else:
...
if __name__ == "__main__":
    ...
    export_ymfs_timesteps(egrid_file)
